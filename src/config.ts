...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://woblog.ccwu.cc/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-05-30", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "1253145", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "1054456879", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "沃德天の小屋", // 主页横幅主标题

			subtitle: [
				"行到水穷处，坐看云起时",
				"内心充盈者，独行也如众",
				"风乍起，吹皱一池春水，干卿何事？雨初霁开遍满园桃李，与我何干！",
			],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/fqxmczw",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1054456879",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/feiqiuxiaomao",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		},
		{
			...
			url: "https://t.me/wodet_kongcl",
		},
		{
			name: "Coolmarket",
			icon: "fa7-brands:discord",
			url: "coolmarket://u/23566944",
		},
	],
};
